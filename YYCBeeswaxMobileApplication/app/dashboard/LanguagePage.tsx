...
const LanguageSelectionPage = () => {
  ...
  const availableLanguages = ['English', 'French', 'Spanish', 'German', 'Chinese'];
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
          ...
          {availableLanguages.map((language) => (
            <View key={language} style={styles.languageContainer}>
              ...
              <TouchableOpacity
                style={[
                  styles.circleButton,
                  selectedLanguage === language ? styles.blueCircle : styles.clearCircle,
                ]}
        ...
        <View style={styles.bottomContainer}>
          <SubmitButton title="Confirm Changes" handleClick={handleConfirmChange} />
          <NavBar />
        </View>
      </View>
    </SafeAreaView>
